...
Invoke-WebRequest -Uri https://www.nrc.nl/rubriek/ellen-deckwitz/ `
...
| ForEach-Object {
    ...
    Save-EntryToAirTable -Url $Url -Date $Date -Title "Ellen Deckwitz: $Title" -Body $Body -TableName Mail
}